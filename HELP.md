...
* [OAuth2 Client](https://docs.spring.io/spring-boot/4.1.2-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
* [Spring Data JPA](https://docs.spring.io/spring-boot/4.1.2-SNAPSHOT/reference/data/sql.html#data.sql.jpa-and-spring-data)
* [Liquibase Migration](https://docs.spring.io/spring-boot/4.1.2-SNAPSHOT/how-to/data-initialization.html#howto.data-initialization.migration-tool.liquibase)
